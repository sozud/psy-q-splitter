...
/* 12A30 80022230 09800C3C */  lui        $t4, %hi(svm_cur_0F)
/* 12A34 80022234 D7788C91 */  lbu        $t4, %lo(svm_cur_0F)($t4)
...
/* 12A5C 8002225C 0480013C */  lui        $at, %hi(_svm_voice_1B)
/* 12A60 80022260 21082300 */  addu       $at, $at, $v1
/* 12A64 80022264 43B82290 */  lbu        $v0, %lo(_svm_voice_1B)($at)
/* 12A68 80022268 00000000 */  nop
/* 12A6C 8002226C 09004014 */  bnez       $v0, .L80022294
/* 12A70 80022270 FF00E230 */   andi      $v0, $a3, 0xFF
/* 12A74 80022274 0480013C */  lui        $at, %hi(_svm_voice_06)
/* 12A78 80022278 21082300 */  addu       $at, $at, $v1
/* 12A7C 8002227C 2EB82294 */  lhu        $v0, %lo(_svm_voice_06)($at)
...
/* 12AA8 800222A8 0480013C */  lui        $at, %hi(_svm_voice_18)
/* 12AAC 800222AC 21082300 */  addu       $at, $at, $v1
/* 12AB0 800222B0 40B82684 */  lh         $a2, %lo(_svm_voice_18)($at)
...
/* 12ACC 800222CC 0480013C */  lui        $at, %hi(_svm_voice_06)
/* 12AD0 800222D0 21082300 */  addu       $at, $at, $v1
/* 12AD4 800222D4 2EB82B94 */  lhu        $t3, %lo(_svm_voice_06)($at)
/* 12AD8 800222D8 0480013C */  lui        $at, %hi(_svm_voice_02)
/* 12ADC 800222DC 21082300 */  addu       $at, $at, $v1
/* 12AE0 800222E0 2AB82894 */  lhu        $t0, %lo(_svm_voice_02)($at)
...
/* 12AF4 800222F4 0480013C */  lui        $at, %hi(_svm_voice_06)
/* 12AF8 800222F8 21082300 */  addu       $at, $at, $v1
/* 12AFC 800222FC 2EB82494 */  lhu        $a0, %lo(_svm_voice_06)($at)
...
/* 12B10 80022310 0480013C */  lui        $at, %hi(_svm_voice_02)
/* 12B14 80022314 21082300 */  addu       $at, $at, $v1
/* 12B18 80022318 2AB82894 */  lhu        $t0, %lo(_svm_voice_02)($at)
...
/* 12B2C 8002232C 0480013C */  lui        $at, %hi(_svm_voice_02)
/* 12B30 80022330 21082300 */  addu       $at, $at, $v1
/* 12B34 80022334 2AB82284 */  lh         $v0, %lo(_svm_voice_02)($at)
...
/* 12BD4 800223D4 0480013C */  lui        $at, %hi(_svm_voice_02)
/* 12BD8 800223D8 21082200 */  addu       $at, $at, $v0
/* 12BDC 800223DC 2AB82394 */  lhu        $v1, %lo(_svm_voice_02)($at)
...
/* 12C14 80022414 0480013C */  lui        $at, %hi(_svm_voice_02)
/* 12C18 80022418 21082200 */  addu       $at, $at, $v0
/* 12C1C 8002241C 2AB820A4 */  sh         $zero, %lo(_svm_voice_02)($at)
/* 12C20 80022420 0980033C */  lui        $v1, %hi(svm_cur_0F)
/* 12C24 80022424 D7786390 */  lbu        $v1, %lo(svm_cur_0F)($v1)
/* 12C28 80022428 0480013C */  lui        $at, %hi(_svm_voice_18)
/* 12C2C 8002242C 21082200 */  addu       $at, $at, $v0
/* 12C30 80022430 40B823A4 */  sh         $v1, %lo(_svm_voice_18)($at)
/* 12C34 80022434 0480013C */  lui        $at, %hi(_svm_voice_1B)
/* 12C38 80022438 21082200 */  addu       $at, $at, $v0
/* 12C3C 8002243C 43B82390 */  lbu        $v1, %lo(_svm_voice_1B)($at)
...
/* 12C4C 8002244C FF00053C */  lui        $a1, (0xFFFFFF >> 16)
/* 12C50 80022450 FFFFA534 */  ori        $a1, $a1, (0xFFFFFF & 0xFFFF)
